/*
Problem: Write a program that uses console.log to print all the numbers from 1 to 100, with two exceptions. 
...
for (let i = 1; i < 101; ++i) {
    if (i % 15 === 0) {
        // Anything divisible by both 3 and 5 is divisible by 15
